...
namespace SFML
{
    ...
    public class LoadingFailedException : Exception
    {
        ...
        //COMPATIBILITY WITH DOTNET CORE
        //DotNet Core doesn't support the SerializationInfo object.
        //TODO: Determine whether a suitable replacement for this is necessary and, if so, what it should be.
